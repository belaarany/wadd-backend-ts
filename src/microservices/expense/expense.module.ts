...
@Module({
  ...
  providers: [
    ExpenseMicroserviceWalletsService, ExpenseMicroserviceIncomesService, ExpenseMicroserviceExpensesService, ExpenseMicroserviceBalancesService, ExpenseMicroserviceTransfersService, ExpenseMicroserviceCategoriesService
  ],
  exports: [
    ExpenseMicroserviceWalletsService, ExpenseMicroserviceIncomesService, ExpenseMicroserviceExpensesService, ExpenseMicroserviceBalancesService, ExpenseMicroserviceTransfersService, ExpenseMicroserviceCategoriesService
  ]
